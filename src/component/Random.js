...
export default function Random() {
    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='mydiv bg-white bg-opacity-10 px-2 w-fit min-w-[50%] m-auto flex flex-col items-center mt-10'>
                <h1 className='text-white text-xl font-bold my-2'>Random GIF's</h1>
                {spinner ?<Spin/>: <img className='  max-w-96 max-h-96 rounded-lg my-4' src={dat} />}
            </div>
